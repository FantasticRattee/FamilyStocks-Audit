...
- From 5 Aug 2026, pooled assets and aggregate `CASH` use the canonical Total
  Contributed Capital percentages: Mom 46.8334%, Rattee 44.1021%, Ryu 9.0645%.
  Explicitly confirmed owner-specific active overlays, currently Rattee's
  SPCX 2 and INTC 8, remain in the same portfolio proof but their full value
  is added to the named owner's current equity.
