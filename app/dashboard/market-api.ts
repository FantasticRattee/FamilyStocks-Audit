...
const PUBLIC_MARKET_QUOTES = {
  ...
  AAPL: {
    ...
    title: "Google Finance · AAPL (NASDAQ)",
    parser: "google",
    googlePageTitles: ["AAPL:NASDAQ"],
  },
  NVDA: {
    symbol: "NVDA",
    currency: "USD",
    ...
    title: "Google Finance · NVDA (NASDAQ)",
    parser: "google",
    googlePageTitles: ["NVDA:NASDAQ"],
  },
  MU: {
    symbol: "MU",
    currency: "USD",
    exchange: "NASDAQ",
    provider: "Google Finance",
    url: "https://www.google.com/finance/quote/MU:NASDAQ?hl=en",
    title: "Google Finance · MU (NASDAQ)",
    parser: "google",
    googlePageTitles: ["MU:NASDAQ"],
  },
  QQQI: {
    symbol: "QQQI",
    currency: "USD",
    exchange: "NASDAQ",
    provider: "Google Finance",
    url: "https://www.google.com/finance/quote/QQQI:NASDAQ?hl=en",
    title: "Google Finance · QQQI (NASDAQ)",
    parser: "google",
  ...
  WDC: {
    ...
    exchange: "NASDAQ",
    provider: "Google Finance",
    url: "https://www.google.com/finance/quote/WDC:NASDAQ?hl=en",
    title: "Google Finance · WDC (NASDAQ)",
    parser: "google",
  ...
  KLAC: {
    ...
    exchange: "NASDAQ",
    provider: "Google Finance",
    url: "https://www.google.com/finance/quote/KLAC:NASDAQ?hl=en",
    title: "Google Finance · KLAC (NASDAQ)",
    parser: "google",
    googlePageTitles: ["KLAC:NASDAQ"],
  },
  FN: {
    symbol: "FN",
    currency: "USD",
    exchange: "NYSE",
    provider: "Google Finance",
    url: "https://www.google.com/finance/quote/FN:NYSE?hl=en",
    title: "Google Finance · FN (NYSE)",
    parser: "google",
    googlePageTitles: ["FN:NYSE"],
  },
  AMAT: {
    symbol: "AMAT",
    currency: "USD",
    exchange: "NASDAQ",
    provider: "Google Finance",
    url: "https://www.google.com/finance/quote/AMAT:NASDAQ?hl=en",
    title: "Google Finance · AMAT (NASDAQ)",
    parser: "google",
    googlePageTitles: ["AMAT:NASDAQ"],
  },
  CRWV: {
    symbol: "CRWV",
    currency: "USD",
    exchange: "NASDAQ",
    provider: "Google Finance",
    url: "https://www.google.com/finance/quote/CRWV:NASDAQ?hl=en",
    title: "Google Finance · CRWV (NASDAQ)",
    parser: "google",
